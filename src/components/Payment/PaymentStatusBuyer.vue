  ...
  <div class="content">
    ...
    <div class="tab-content">
          ...
          <li v-for="purchase in pendings" :key="purchase.purchaseId" class="list-group-item">
            <div class="sale-item">
              ...
              <div class="sale-actions">
                ...
                <a :href="'http://localhost:8081/' + purchase.imageComprobante" target="_blank"
      ...
      <div v-if="currentTab === 'Aceptados'">
        <h2 class="mb-4">Compras aceptadas</h2>
        <ul class="list-group sales-list">
      ...
      <div v-if="currentTab === 'Rechazados'">
        <h2 class="mb-4">Compras rechazadas</h2>
        <ul class="list-group sales-list">
...
export default {
  ...
  async created() {
    ...
    try {
      ...
      const response = await axios.get(`http://localhost:8081/api/v1/purchase/buyer/${this.userUuid}`);
